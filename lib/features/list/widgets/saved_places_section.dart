...
//   void initState() {
//     super.initState();
//     _placesFuture = AuthService.getSavedRestaurants();
//   }
...
class SavedPlacesSection extends StatefulWidget {
  ...
  const SavedPlacesSection({Key? key, required this.searchQuery}) : super(key: key);
                    ...
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      final filteredPlaces = snapshot.data!.where((place) {
                        return place['name'].toLowerCase().contains(widget.searchQuery.toLowerCase()) ||
                            place['place'].toLowerCase().contains(widget.searchQuery.toLowerCase());
                      }).toList();
